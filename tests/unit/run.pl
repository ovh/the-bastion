...
cmp_deeply(
    ...
    R(
        ...
        value => {
            ...
            "version"   => "6",
            "prefixlen" => "128",
            "ip"        => "0000:0000:0000:0000:0000:feef:0000:0000",
            "type"      => "single",
        }
    ),
...
cmp_deeply(
    ...
    R("OK", msg => ignore(), value => {"prefix" => "0", "ip" => "1.2.0.0/0",}),
...
cmp_deeply(
    ...
    R("OK", msg => ignore(), value => {"prefix" => "32", "ip" => "1.2.0.0/32",}),
...
cmp_deeply(
    ...
    R("OK", msg => ignore(), value => {"prefix" => "32", "ip" => "255.255.255.255/32",}),
...
cmp_deeply(
    OVH::Bastion::is_valid_ip(ip => "4.5.6.0/32", allowPrefixes => 1, fast => 1),
    R("OK", msg => ignore(), value => {"prefix" => "32", "ip" => "4.5.6.0/32",}),
