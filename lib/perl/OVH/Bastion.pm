...
my %_autoload_files = (
    ...
    os => [
        qw{ sysinfo is_linux is_debian is_debian_trixie is_redhat is_freebsd has_acls sys_useradd sys_groupadd sys_userdel sys_groupdel sys_addmembertogroup sys_delmemberfromgroup sys_changepassword sys_neutralizepassword sys_setpasswordpolicy sys_getpasswordinfo sys_getsudoersfolder sys_setfacl is_in_path sys_getpw_all sys_getpw_all_cached sys_getpw_name sys_getgr_all sys_getgr_all_cached sys_getgr_all_byuser sys_getgr_name sys_list_processes }
    ],
