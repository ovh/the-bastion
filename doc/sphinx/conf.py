...
htmlhelp_basename = 'TheBastionDocumentation'
...
latex_documents = [
    (master_doc, 'TheBastion.tex', 'The Bastion Documentation',
     author, 'manual'),
]
...
man_pages = [
    (master_doc, 'thebastion', 'The Bastion Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'TheBastion', 'The Bastion Documentation',
     author, 'TheBastion', 'Authentication, authorization, traceability and auditability for SSH accesses.',
     'Miscellaneous'),
]
