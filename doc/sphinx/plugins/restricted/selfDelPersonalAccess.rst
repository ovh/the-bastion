...
Note that this only removes the access from the bastion; it doesn't remove your personal
egress public key from the remote server, which you may want to do as well.
