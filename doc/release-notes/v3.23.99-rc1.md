...
An important highlight of this pre-release is **performance on large bastions**. Note that part of this work
will only be in the upcoming ``rc2``.
...
for an exhaustive (and boring) list, please refer to the [commit log](https://github.com/ovh/the-bastion/compare/v3.23.01...v3.23.99-rc1).
...
- [Specific upgrade instructions for v3.23.99-rc1](https://ovh.github.io/the-bastion/installation/upgrading.html#v3-23-99-rc1-2026-06-24)
